	...
	<main class="main">
		...
		<div class="content">
			...
			<div>
					...
					value="<?= form_error('title') ? set_value('title') : $books->title ?>" />
				...
				<div>
					...
					<textarea name="content" cols="30" rows="10" placeholder="Tuliskan isi pikiranmu..."><?= form_error('content') ? set_value('content') : $books->content ?></textarea>
				</div>
